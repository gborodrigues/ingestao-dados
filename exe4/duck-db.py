...
directories = {
    'bancos': '../Dados/raw/Bancos/output.parquet/*.parquet',
    'empregados': '../Dados/raw/Empregados/output.parquet/*.parquet',
    'reclamacoes': '../Dados/raw/Reclamacoes/output.parquet/*.parquet'
}
